        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6">
          <div>
            <select>
              ...
              {['myntra', 'nykaa', 'shopify', 'tatacliq', 'ajio', 'shopperstop'].map((ch) => (
                <option key={ch}> {ch?.toUpperCase()} </option>
              ))}
            </select>
            <select>
              <option value="">--Select Brand-- </option>
              {['qurvii', 'qurvii+', 'qurvii desi'].map((brand) => (
                <option key={brand}> {brand?.toUpperCase()} </option>
              ))}
            </select>
          </div>
          ...
          <div className="mt-8 bg-blue-50 rounded-lg p-4">
            ...
            <div className="mt-4">
              <a
                className="py-2 px-4 font-medium bg-purple-400 rounded-md hover:bg-purple-500 duration-75 ease-in"
