...
const generateAjioJacketsPlusListing = (selectedData) => {
    const csvHeaders = [
        "Style Code",
        "Style Description",
        "Item SKU",
    ...
    const csvData = selectedData.filter((product) => product.styleType === "Coat" || product.styleType === "Jacket" || product.styleType.includes("Jacket"))
        .flatMap((product) =>
            sizes.map((size) => {
    ...
    link.download = "ajio_jacket_plus_listing.csv";
...
export default generateAjioJacketsPlusListing;