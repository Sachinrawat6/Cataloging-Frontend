...
const generateAjioDressPlusListing = (selectedData) => {
    const csvHeaders = [
        "Style Code",
        "Style Description",
        "Item SKU",
    ...
    const csvData = selectedData.filter((product) => product.styleType === "Dress" || product.styleType === "Kaftan")
        .flatMap((product) =>
            sizes.map((size) => {
    ...
    link.download = "ajio_dress_plus_listing.csv";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
};

export default generateAjioDressPlusListing;
