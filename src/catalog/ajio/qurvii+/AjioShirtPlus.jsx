...
const generateAjioShirtPlusListing = (selectedData) => {
    const csvHeaders = [
        "Style Code",
        "Style Description",
        "Item SKU",
    ...
    const csvData = selectedData.filter((product) => product.styleType === "Shirt" || product.styleType.includes("Shirt"))
        .flatMap((product) =>
            sizes.map((size) => {
                ...
                if (product.stylePrimaryColor && product.stylePrimaryColor.trim() !== "") {
                    colorShade =
                        product.stylePrimaryColor.trim().toLowerCase() === "pastel"
                            ? "Light"
                            : "Dark";
                }
                ...
                return {
                    ...
                    Length: "",
                    "Sleeve Length": product.measurements.sleeveLengthXS || "",
                    "Sleeve Type": sleeveLength || "",
                    StandardSize: mappedSize,
                    "Style Type": "",
                    Transparency: product.transparency || "Opaque",
...
export default generateAjioShirtPlusListing;
