...
const generateAjioShurgsPlusListing = (selectedData) => {
    const csvHeaders = [
        "Style Code",
        "Style Description",
        "Item SKU",
    ...
    const csvData = selectedData.filter((product) => product.styleType === "Shrug" || product.styleType.includes("Shrug"))
        .flatMap((product) =>
            sizes.map((size) => {
    ...
    link.download = "ajio_shurgs_Plus_listing.csv";
...
export default generateAjioShurgsPlusListing;