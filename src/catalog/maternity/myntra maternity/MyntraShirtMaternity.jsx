...
const generateMyntraShirtMaternityListingFile = (selectedData, csvHeaders) => {
  const sizeMapping = {
    XXS: 'XXS',
    XS: 'XS',
    S: 'S',
  ...
  try {
    ...
    const csvData = selectedData
      .filter(
        (product) =>
          product.styleType.toLowerCase().trim() === 'shirt' ||
          product.styleType.toLowerCase().trim() === 'sweatshirt'
...
export { generateMyntraShirtMaternityListingFile };
