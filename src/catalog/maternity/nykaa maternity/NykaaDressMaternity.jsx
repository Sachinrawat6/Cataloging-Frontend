...
const generateNykaaDressMaternityListing = (selectedData, headers) => {
    ...
    .flatMap((product) =>
      sizes.map((size) => {
        ...
        return {
          ...
          'Net Qty': '1N',
          // Material: product.fabrics[0]?.name || "",
          ...
          'Pocket Description': '',
          Closure:
            product.closure?.toLowerCase().trim() === 'not applicable'
              ? 'Other'
              : product.closure || '',
...
export default generateNykaaDressMaternityListing;
