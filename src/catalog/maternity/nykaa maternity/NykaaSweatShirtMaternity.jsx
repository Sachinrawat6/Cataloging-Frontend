...
const generateNykaaSweatShirtMaternityListing = (selectedData, headers) => {
  ...
  const csvData = selectedData
    ...
    .flatMap((product) =>
      sizes.map((size) => {
        ...
        //     product.fabrics[0].name = fabricMapping[product.fabric[0].name];
        // }
        // Season mapping
        const seasonMapping = {
        ...
        return {
          ...
          'Net Qty': '1N',
          // Material: product?.fabric[0]?.name || "",
  ...
  link.download = 'Nykaa_sweatShirt_listing.csv';
  document.body.appendChild(link);
  link.click();
  document.body.removeChild(link);
};

export { generateNykaaSweatShirtMaternityListing };
