...
const generateNykaaTopMaternityListing = (selectedData, headers) => {
  const csvHeaders = headers;
  console.log('inside listing function', csvHeaders);
  const sizeMapping = {
    XXS: 'XXS',
    XS: 'XS',
    S: 'S',
  ...
  const csvData = selectedData
    .filter((product) => product.styleType?.toLowerCase === 'top')
    .flatMap((product) =>
      sizes.map((size) => {
...
export { generateNykaaTopMaternityListing };
