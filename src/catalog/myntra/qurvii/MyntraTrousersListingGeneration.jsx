...
const generateMyntraTrousersListingFile = (selectedData, csvHeaders) => {
  // const csvHeaders = [
  //     "styleId",
  //     "styleGroupId",
  //     "vendorSkuCode",
      ...
      .flatMap((product, index) =>
        sizes.map((size) => {
          ...
          const productData = {
            ...
            vendorSkuCode: `${product.styleNumber}-${product.stylePrimaryColor}-${mappedSize}`,
...
export { generateMyntraTrousersListingFile };
