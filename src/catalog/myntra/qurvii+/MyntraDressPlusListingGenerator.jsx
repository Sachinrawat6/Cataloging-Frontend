...
const generateMyntraDressPlusListingFile = (selectedData, csvHeaders) => {
  // const csvHeaders = [
  //     "styleId",
  //     "styleGroupId",
  //     "vendorSkuCode",
  ...
  try {
    ...
    const csvData = selectedData
      .filter(
        (product) =>
          product.styleType === 'Dress' ||
          product.styleType === 'Kaftan' ||
...
export { generateMyntraDressPlusListingFile };
