...
const generateMyntraCoatsPlusListingFile = (selectedData, csvHeaders) => {
  // const csvHeaders = [
  //     "styleId",
  //     "styleGroupId",
  //     "vendorSkuCode",
  ...
  try {
    ...
    link.download = 'Myntra_Coat_Plus_Size_listing.csv';
...
export { generateMyntraCoatsPlusListingFile };
