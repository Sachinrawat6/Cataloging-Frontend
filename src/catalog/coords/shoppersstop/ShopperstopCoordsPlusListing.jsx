...
const generateShoppersStopCoordsPlusListing = (coords, selectedData) => {
    const csvHeaders = [
        "STOCK",
        "HSN",
        "MRP",
    ...
    link.download = "shoppersstop_Coords_Plus_listing.csv";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
};

export default generateShoppersStopCoordsPlusListing;
