...
const generateNykaaPlusDressListing = (selectedData) => {
    const csvHeaders = [
        "Vendor SKU Code",
        "Gender",
        "Brand Name",
    ...
    const csvData = selectedData
        .filter((product) => product.styleType === "Dress" || product.styleType === "Kaftan" || product.styleType.toLowerCase().includes("shirt dress"))
        .flatMap((product) =>
            sizes.map((size) => {
                ...
                return {
                    "Vendor SKU Code": `${"8" + product.styleNumber.toString().substring(1)}-${product.stylePrimaryColor}-${mappedSize}`,
                    Gender: "Women",
                    "Brand Name": "Qurvii",
                    ...
                    "Collections Function": "",
                    "Pocket Description": "",
                    Closure: product.closure?.toLowerCase().trim() === "not applicable" ? "Other" : product.closure || "",
                    ...
                    "Sleeve Length": product.measurements?.sleeveLengthXS || 0,
...
export default generateNykaaPlusDressListing;
